...
@ViewLayer
class DataStatisticalAct : BaseTallyActivity<DataStatisticalViewModel>() {

    override fun getViewModelClass(): Class<DataStatisticalViewModel> {
        return DataStatisticalViewModel::class.java
    }
