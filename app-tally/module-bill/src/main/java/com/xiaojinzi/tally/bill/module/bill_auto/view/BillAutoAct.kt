...
@RouterAnno(
    ...
    interceptors = [AutoBillCheckInterceptor::class],
)
@ViewLayer
class BillAutoAct : BaseTallyActivity<BillAutoViewModel>() {

    override fun getViewModelClass(): Class<BillAutoViewModel> {
        return BillAutoViewModel::class.java
    }
    ...
    override fun onResume() {
        super.onResume()
        requiredViewModel().checkAutoBillFeature(context = mContext)
    }
